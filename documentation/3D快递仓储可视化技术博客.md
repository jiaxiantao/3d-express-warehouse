...
![控制台全貌（截图占位）](images/blog-01-dashboard.png)
...
![架构示意（截图占位）](images/blog-07-architecture.png)
...
![多状态货位颜色（截图占位）](images/blog-02-status-colors.png)
...
![低库存筛选效果（截图占位）](images/blog-03-filter-low-stock.png)
...
![选中流动描边（截图占位）](images/blog-04-selection-outline.png)
...
![货位详情面板（截图占位）](images/blog-05-slot-panel.png)
...
![三种视角对比（截图占位）](images/blog-06-camera-views.png)
...
- [3D快递仓储可视化重磅升级技术博客](./3D快递仓储可视化重磅升级技术博客.md) — v2 重磅升级：机器人、三视角、分类标签、扫码定位  
